...
int PLG_UpdateHeaderWAV(SOUNDFMT *pOutFmt,long filesize,long datasize,char *header,long header_size);
int PLG_MakeHeaderRF64(SOUNDFMT *pInFmt,SOUNDFMT *pOutFmt,char *header,long size,long *header_size);
int PLG_UpdateHeaderRF64(SOUNDFMT *pOutFmt,long filesize,long datasize,char *header,long header_size);
